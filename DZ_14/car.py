class Car:
 ...
 def __str__(self):
   return print(F" {self.car_name} {self.car_year} release , mileage - {self.car_mileage} km, price - {self.car_price}$")
 ...
 def __eq__(self, other):
     if self.car_year != other.car_year and self.car_name != other.car_name:
      ...
      return print(F"Cars {self.car_name} and {other.car_name} have the same year of manufacture and brand of manufacturer")
     elif self.car_year == other.car_year and self.car_name != other.car_name:
      return print(F"Cars {self.car_name} and {other.car_name} have the same year of manufacture, but differ in the make of the manufacturer")
     elif self.car_year != other.car_year and self.car_name == other.car_name:
      return print(F"Cars {self.car_name} and {other.car_name} of the same brand of manufacturer, but differ in the year of manufacture")
